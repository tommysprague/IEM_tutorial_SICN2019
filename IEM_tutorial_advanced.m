...
%   2016), a commonly-used metric. We'll also discuss when it's appropriate
%   to do curve-fitting to quantify 'amplitude' and 'size'
%
...
%compute_fidelity = @(rec) mean( rec .* cosd(angs) ,2); % compatible w/ newer matlab
compute_fidelity = @(rec) mean( bsxfun(@times,rec,cosd(angs)) ,2); % for older versions, use this
